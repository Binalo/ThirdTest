...
namespace QuanLyNhanVien
{
    class XmlHandler
    {
        ...
        public void create(List<Employee> empList)
        {
            ...
            foreach (Employee emp in empList)//Duyet het cac nhan vien co trong danh sach
            {
        ...
        public bool add(Employee emp)
        {
            ...
            empList = new List<Employee>(); /*Tao moi 1 danh sach nhan vien de 
        ...
        public bool isExistId(List<Employee> empList, string id)
        {
            ...
            foreach (Employee emp in empList)//Duyet tung nhan vien trong danh sach
            {
